...
export class ArquivoExercicioController {
    constructor(
        private readonly arquivoExercicioService: ArquivoExercicioService,
    ) {}
    ...
    update(
        @Param('id') id: string,
        @Body() updateArquivoExercicioDto: UpdateArquivoExercicioDto,
    ) {
        return this.arquivoExercicioService.update(
            +id,
            updateArquivoExercicioDto,
        );
    }
